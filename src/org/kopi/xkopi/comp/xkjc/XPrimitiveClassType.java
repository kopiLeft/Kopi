 ...
 */
public abstract class XPrimitiveClassType extends org.kopi.kopi.comp.kjc.CReferenceType {
...
//   static {
//     instance = new org.kopi.kopi.comp.kjc.MethodSignatureParser() {
...
// 	  if (((CReferenceType)type).getQualifiedName() == org.kopi.xkopi.lib.type.NotNullDate.class.getName().replace('.','/')) {
// 	    return XStdType.PDate;
// 	  } else if (((CReferenceType)type).getQualifiedName() == org.kopi.xkopi.lib.type.NotNullFixed.class.getName().replace('.','/')) {
// 	    return XStdType.PFixed;
// 	  } else if (((CReferenceType)type).getQualifiedName() == org.kopi.xkopi.lib.type.NotNullMonth.class.getName().replace('.','/')) {
// 	    return XStdType.PMonth;
// 	  } else if (((CReferenceType)type).getQualifiedName() == org.kopi.xkopi.lib.type.NotNullTime.class.getName().replace('.','/')) {
// 	    return XStdType.PTime;
// 	  } else if (((CReferenceType)type).getQualifiedName() == org.kopi.xkopi.lib.type.NotNullWeek.class.getName().replace('.','/')) {
...
//   }
  ...
  public abstract org.kopi.kopi.comp.kjc.CReferenceType getNotNullableClass();
