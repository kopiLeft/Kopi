...
public class DateType extends org.kopi.xkopi.comp.sqlc.Type implements DbiType {
   ...
   */
  public DateType(TokenReference ref) {
    super(ref);
  }
 ...
 /**
  ...
  public DatabaseColumn getColumnInfo(boolean nullable) {
    return new DatabaseDateColumn(nullable);
  }  
