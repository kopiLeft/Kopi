...
import org.kopi.xkopi.comp.database.DatabaseWeekColumn;
import org.kopi.xkopi.comp.sqlc.Type;

public class WeekType extends Type implements DbiType {
   ...
   */
  public WeekType(TokenReference ref) {
    super(ref);
  }
 ...
 /**
  ...
  public DatabaseColumn getColumnInfo(boolean nullable) {
    return new DatabaseWeekColumn(nullable);
  } 
  // --------------------------------------------------------------------
  // ACCEPT VISITORS
  // --------------------------------------------------------------------
