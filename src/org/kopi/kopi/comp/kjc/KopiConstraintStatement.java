...
//     if (%(boolean)[0]) {
//       if (!(org.kopi.kopi.lib.assertion.AssertionRuntime.getRunAssertion(Thread.currentThread()))) {
//         org.kopi.kopi.lib.assertion.AssertionRuntime.setRunAssertion(Thread.currentThread(), true);
//         try {
//           %[0]     // invariant
//           %[2]     // precondition
//           %[3]     // postcondition  storage
//         } finally {
//           org.kopi.kopi.lib.assertion.AssertionRuntime.setRunAssertion(Thread.currentThread(), false);
//         }
//       }
//     }
//     try {
