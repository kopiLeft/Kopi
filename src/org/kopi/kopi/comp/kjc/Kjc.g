...
header { package org.kopi.kopi.comp.kjc; }
{
...
options {
  ...
  superClass = "org.kopi.compiler.tools.antlr.extra.Parser";
      ...
      if (environment.getAssertExtension() == KjcEnvironment.AS_ALL) {
        ...
        self = new KopiConstructorDeclaration(sourceRef,
                                              ...
                                              new KopiConstructorBlock(sourceRef,
                                                                       constructorCall,
                                                                       (JStatement[]) body.toArray(new JStatement[body.size()])), //org.kopi.util.base.Utils.toArray(body, JStatement.class)),
                                              javadoc,
                                              getStatementComment(),
                                              pre,
                                              post,
...
:
  ...
  { self = (JExpression[])vect.toArray(new JExpression[vect.size()]); } //org.kopi.util.base.Utils.toArray(vect, JExpression.class); }
;
...
:
  ...
  { self = (JExpression[]) container.toArray(new JExpression[container.size()]); } //org.kopi.util.base.Utils.toArray(container, JExpression.class); }
;
