 ...
 */
public class Commandable implements org.kopi.vkopi.lib.form.VConstants, org.kopi.kopi.comp.kjc.Constants {
  ...
  public JMethodDeclaration buildTriggerHandler(TypeFactory tf, TokenReference ref, String methodName, int type) {
    ...
    switchStmt = new JSwitchStatement(ref,
				      new JNameExpression(ref, "VKT_Type"),
				      (JSwitchGroup[])org.kopi.util.base.Utils.toArray(switchBody, JSwitchGroup.class),
				      null);
    ...
    if (allowSQLInTriggers) {
      ...
      exc2 = new JUnqualifiedInstanceCreation(ref,
                                              tf.createType("org/kopi/vkopi/lib/visual/VExecFailedException", false),
