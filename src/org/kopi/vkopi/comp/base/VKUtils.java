...
public class VKUtils {
  ...
  public static final CReferenceType[]	VECT_VException = new CReferenceType[] {CReferenceType.lookup(org.kopi.vkopi.lib.visual.VException.class.getName().replace('.','/'))};
