...
header { package org.kopi.vkopi.comp.trig; }
{
...
:
{
  ...
  context.addPackageImport(new JPackageImport(TokenReference.NO_REF, "org/kopi/xkopi/lib/base", null));
  context.addPackageImport(new JPackageImport(TokenReference.NO_REF, "org/kopi/xkopi/lib/type", null));
...
:
  ...
  |
    SEMI
      { reportTrouble(new CWarning(sourceRef, org.kopi.kopi.comp.kjc.KjcMessages.STRAY_SEMICOLON, null)); }
  )*
  RCURLY
;
