...
public class PRTextBlock extends PRBlock {
  ...
  public String getSuperName() {
    return org.kopi.vkopi.lib.print.PTextBlock.class.getName().replace('.','/');
  }

  public CType getType() {
    return CReferenceType.lookup(org.kopi.vkopi.lib.print.PTextBlock.class.getName().replace('.','/'));
  }
