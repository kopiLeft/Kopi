...
public class PRUtils extends VKUtils {
  ...
  private static CReferenceType	LIST_TYPE	= CReferenceType.lookup(org.kopi.vkopi.lib.print.PListBlock.class.getName().replace('.','/'));
  private static CReferenceType	BLOCK_STYLE_TYPE= CReferenceType.lookup(org.kopi.vkopi.lib.print.PBlockStyle.class.getName().replace('.','/'));
}
