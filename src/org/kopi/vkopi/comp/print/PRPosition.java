...
public class PRPosition extends VKPhylum {
  ...
  private static CReferenceType	PPOSITION_TYPE	= CReferenceType.lookup(org.kopi.vkopi.lib.print.PPosition.class.getName().replace('.','/'));
  private static CReferenceType	PSIZE_TYPE	= CReferenceType.lookup(org.kopi.vkopi.lib.print.PSize.class.getName().replace('.','/'));
