...
public class VKBlockAlign extends VKPhylum {
  ...
  public void checkCode(VKContext context, VKBlock block) throws PositionedError {
    ...
    check(block.getAlignment() == org.kopi.vkopi.lib.form.VConstants.ALG_LEFT,
    ...
    //    check(other.getAlignment() == org.kopi.vkopi.lib.form.VConstants.ALG_LEFT,
  ...
  private static final CReferenceType	TYPE = CReferenceType.lookup(org.kopi.vkopi.lib.form.BlockAlignment.class.getName().replace('.','/'));
