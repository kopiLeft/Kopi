...
import org.kopi.vkopi.lib.l10n.ReportLocalizer;
...
public abstract class VReport extends VWindow implements Constants, VConstants, Printable {
  ...
  public int getType() {
    return org.kopi.vkopi.lib.visual.Constants.MDL_REPORT;
  }
  ...
  public void executeVoidTrigger(final int VKT_Type) throws org.kopi.vkopi.lib.visual.VException {
  }
