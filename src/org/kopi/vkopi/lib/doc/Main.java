...
package org.kopi.vkopi.lib.doc;
...
public class Main {
  ...
  private static final void displayUsage() {
    ...
    System.err.println("Exemple: java org.kopi.drivers.kopi.help.Main bugs \"kopiRight Bugs Report\" user@jdbc:tbx://vie:4002/INTERN org.kopi.tbx.TbxDriver XXXXXX");
  }
...
//    try {
//      UIManager.setLookAndFeel(new org.kopi.vkopi.lib.ui.plaf.KopiLookAndFeel());//UIManager.getSystemLookAndFeelClassName());
//    } catch (Exception e) {
