...
import org.kopi.vkopi.lib.ui.vaadinflow.form.DImageField.DynamicImageResource
          ...
          ComponentRenderer { item: ListDialogItem ->
            ...
            if (image != null) {
              image.apply {
                ...
                setSrc(DynamicImageResource(createFileName("image")) { ByteArrayInputStream(image.source) })
              }
              image
            } else {
              Image()
