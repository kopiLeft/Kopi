...
public class StrategyUIExecutor implements UIExecutor {
   ...
   * for the default
   */
  public StrategyUIExecutor(UILocator uiLocator, UIPreparer executionPreparer, Executor executor) {
   ...
   * completes.
   */
  public static class DynamicPollingManualPushUIPreparer implements UIPreparer {
     ...
     */
    public DynamicPollingManualPushUIPreparer(int normalPollInterval, int workPollInterval) {
      this.normalPollInterval = normalPollInterval;
      this.workPollInterval = workPollInterval;
      this.uiConnectorIdTaskCountMap = new HashMap<String, Integer>();
    }
...
//      }
      ...
      int pendingTasks = uiConnectorIdTaskCountMap.containsKey(ui.getConnectorId()) ?
