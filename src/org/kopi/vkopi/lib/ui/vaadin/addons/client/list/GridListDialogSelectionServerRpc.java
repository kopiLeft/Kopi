...
/**
 * Client side to server side communication for grid rows selection.
 */
public interface GridListDialogSelectionServerRpc extends ServerRpc {
  
  /**
   * Notifies the server side to select the given target.
