...
public abstract class Colors {
  ...
  /**
   * Returns the RGB equivalent value of the color.
  ...
  /**
   * Returns the RGBA equivalent value of the color.
   * @param color The color to be converted.
   * @return The RGBA value of the color.
   */
  public static String toRGBA(Color color) {
    return "rgba(" + color.getRed() + "," + color.getGreen() + ", " + color.getBlue() + ", " + getAlpha(color) + ")";
  }
  ...
  /**
   * Returns the alpha 0 --> 1 value of a given 0 --> 255 alpha color value.
   * @param color The color to calculate its alpha value.
   * @return The [0-1] alpha color value.
   */
  private static String getAlpha(Color color) {
    return new DecimalFormat("#.#").format((float)color.getAlpha() / 255);
  }
  ...
  public static final Color             BISUQE = new Color(255, 228, 196);
  ...
  // theme colors
  public static final Color             DEF_AXIS_GRID_COLOR = new Color(102, 102, 102, 102);
  public static final Color             DEF_AXIS_LINE_COLOR = new Color(102, 102, 102, 102);
}
