 ...
 *
 * $Id: DGridBlockCellStyleGenerator.java 35180 2017-07-14 16:31:39Z hacheni $
 */

package org.kopi.vkopi.lib.ui.vaadin.form;

import org.kopi.vkopi.lib.ui.vaadin.form.DGridBlockContainer.GridBlockProperty;

import com.vaadin.data.Container.Filter;
import com.vaadin.data.Item;

@SuppressWarnings("serial")
public final class DGridBlockFilter implements Filter {

  //---------------------------------------------------
  // CONSTRUCTOR
  //---------------------------------------------------
  
  public DGridBlockFilter(Object propertyId,
                    String filterString,
                    boolean ignoreCase,
  ...
  {
    final GridBlockProperty     property;
    final Object                propertyValue;
    final String                value;
    
    property = (GridBlockProperty) item.getItemProperty(propertyId);
    if (property == null) {
      return false;
    }
  ...
  public boolean equals(Object obj) {
    ...
    final DGridBlockFilter o = (DGridBlockFilter) obj;
