...
public class ChartKeyedValues {
   ...
   */
  public List<Comparable<?>> getXAxisLabels() {
    return dimensions;
  }
   ...
   */
  public List<ChartData> createChartsSeries(DAbstractChartType type)
    throws DataMismatchException
  {
    List<ChartData>          chartsSeries;

    chartsSeries = new ArrayList<ChartData>();
    for (String measure : getMeasures()) {
      ...
      chartsSeries.add(type.createChartSeries(getXAxisLabels(), measure, value.getValues()));
    }
