...
import org.kopi.xkopi.lib.base.XInterruptProtectedException;
...
public abstract class VWindow implements DBContextHandler, KopiExecutable, ActionHandler, VModel {
   ...
   */
  public boolean doModal(Frame f) throws org.kopi.vkopi.lib.visual.VException {
   ...
   * @exception	VException	an exception may be raised by triggers
   */
  public boolean doModal(VWindow f) throws org.kopi.vkopi.lib.visual.VException {
    return WindowController.getWindowController().doModal(this);
  }
   ...
   * @exception	VException	an exception may be raised by triggers
   */
  public boolean doModal() throws org.kopi.vkopi.lib.visual.VException {
    return WindowController.getWindowController().doModal(this);
  }
   ...
   */
  public void reset() throws org.kopi.vkopi.lib.visual.VException {
  ...
  public final void fatalError(Object data, String line, Throwable reason) {
    ...
    if (ApplicationContext.getDefaults().isDebugModeEnabled()) {
      ...
      error(org.kopi.vkopi.lib.visual.MessageCode.getMessage("VIS-00041"));
    }
  ...
  */
  ...
  public static final String    	WINDOW_LOCALIZATION_RESOURCE = "org/kopi/vkopi/lib/resource/Window";
