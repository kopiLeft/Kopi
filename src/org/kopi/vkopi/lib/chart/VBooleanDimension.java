...
public class VBooleanDimension extends VDimension {
  ...
  private static String		trueRep = org.kopi.vkopi.lib.visual.VlibProperties.getString("true");
  private static String 	falseRep = org.kopi.vkopi.lib.visual.VlibProperties.getString("false");
}
