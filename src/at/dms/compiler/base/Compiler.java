 ...
 *
 * $Id: Compiler.java,v 1.1 2004/07/28 18:43:29 imad Exp $
 */
...
public abstract class Compiler {
   ...
   * @param	files			a list of names
   * @return	a list of files known to exist
   * @exception	UnpositionedError	at least one file does not exist
   */
  public List verifyFiles(List names) throws UnpositionedError {
    return Utils.toList(verifyFiles((String[])Utils.toArray(names, String.class)));
  }
