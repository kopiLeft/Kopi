 ...
 *
 * $Id: LpR.java,v 1.1 2004/07/28 18:43:29 imad Exp $
 */
...
public class LpR {
   ...
   * @exception	at.dms.util.lpr.LpdException	if some problems occurs during
   *				connection to lpd
   */
  ...
  /**
   * Program entry point
   * @exception	at.dms.util.lpr.LpdException	problem during communication with lpd
