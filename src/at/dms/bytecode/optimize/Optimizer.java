 ...
 *
 * $Id: Optimizer.java,v 1.1 2004/07/28 18:43:29 imad Exp $
 */
...
public class Optimizer implements AccessorContainer {
  ...
  private void dumpCode() {
    int		i = 0;
    for (InstructionHandle handle = this.codeStart; handle != null; handle = handle.getNext()) {
      System.err.println(i++ + ":\t" + at.dms.bytecode.classfile.OpcodeNames.getName(handle.getInstruction().getOpcode()));
    }
    System.err.flush();
  }
