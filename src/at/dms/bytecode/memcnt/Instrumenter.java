 ...
 *
 * $Id: Instrumenter.java,v 1.1 2004/07/28 18:43:29 imad Exp $
 */
 ...
 */
public class Instrumenter implements at.dms.bytecode.classfile.Constants {
  ...
  private void instrumentInitializer() {
    ...
    insns = new Instruction[] {
      ...
      new MethodRefInstruction(opc_invokestatic, "at/dms/bytecode/memcnt/Registry/register", "(Ljava/lang/String;)V")
    };
