 ...
 *
 * $Id: Commandable.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
 ...
 */
public class Commandable implements at.dms.vkopi.lib.form.VConstants, at.dms.kopi.comp.kjc.Constants {
  ...
  public JMethodDeclaration buildTriggerHandler(TypeFactory tf, TokenReference ref, String methodName, int type) {
    ...
    switchStmt = new JSwitchStatement(ref,
				      new JNameExpression(ref, "VKT_Type"),
				      (JSwitchGroup[])at.dms.util.base.Utils.toArray(switchBody, JSwitchGroup.class),
				      null);
    ...
    if (allowSQLInTriggers) {
      ...
      exc2 = new JUnqualifiedInstanceCreation(ref,
                                              tf.createType("at/dms/vkopi/lib/visual/VExecFailedException", false),
