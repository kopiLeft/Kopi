 ...
 *
 * $Id: VKIntegerCodeType.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
...
public class VKIntegerCodeType extends VKCodeType {
  ...
  public CReferenceType getType() {
    return at.dms.vkopi.comp.trig.GStdType.IntegerCodeField;
  }
  ...
  public CReferenceType getReportType() {
    return at.dms.vkopi.comp.trig.GStdType.IntegerCodeColumn;
  }
