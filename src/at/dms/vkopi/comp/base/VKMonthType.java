 ...
 *
 * $Id: VKMonthType.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
...
import at.dms.xkopi.comp.database.DatabaseMonthColumn;
...
public class VKMonthType extends VKType {
  ...
  public CReferenceType getType() {
    return at.dms.vkopi.comp.trig.GStdType.MonthField;
  }
  ...
  public CType getStandardType() {
    return at.dms.xkopi.comp.xkjc.XStdType.Month;
  }
  /**
  ...
  public CReferenceType getReportType() {
    return at.dms.vkopi.comp.trig.GStdType.MonthColumn;
  }
