 ...
 *
 * $Id: VKPrettyPrinter.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
...
import at.dms.vkopi.comp.trig.GKjcPrettyPrinter;
...
/*
	...
	if (pack.equals("at.dms.vkopi.lib.visual")) {
	  continue;
	}
	if (pack.equals("at.dms.vkopi.lib.util")) {
	  continue;
	}
	if (pack.equals("at.dms.xkopi.lib.base")) {
	  continue;
	}
	if (pack.equals("java.sql")) {
	  continue;
	}
	if (pack.equals("at.dms.vkopi.lib.form")) {
	  continue;
	}
	newLine();
	print("import\t" + pack + ".*;");
  ...
  protected void printCopyright(String name) {
    print("///////////////////////////////////////////////////////////////////////////////");
    newLine();
    print("/// (c) Copyright 1990-2001 DMS Decision Management Systems Ges.m.b.H.      ///");
    newLine();
    print("/// All rights reserved.                                                    ///");
    newLine();
    print("///////////////////////////////////////////////////////////////////////////////");
    newLine();
    print("/// $Id: VKPrettyPrinter.java,v 1.1 2004/07/28 18:43:28 imad Exp $");
    newLine();
    print("///////////////////////////////////////////////////////////////////////////////");
    newLine();
  }
