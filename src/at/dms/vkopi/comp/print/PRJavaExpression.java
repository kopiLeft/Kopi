 ...
 *
 * $Id: PRJavaExpression.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
 ...
 */
public class PRJavaExpression extends PRSourceElement {

  // ----------------------------------------------------------------------
  // CONSTRUCTOR
  // ----------------------------------------------------------------------

  public PRJavaExpression(TokenReference where, JExpression expr) {
    super(where);
  ...
  public JStatement genCode() {
    return PRUtils.addExpression(getTokenReference(), expr);
  }
