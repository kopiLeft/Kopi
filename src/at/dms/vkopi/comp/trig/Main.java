 ...
 */
public class Main extends at.dms.xkopi.comp.xkjc.Main {
  ...
  protected boolean filterWarning(CWarning warning) {
    if (warning.hasDescription(at.dms.kopi.comp.kjc.KjcMessages.METHOD_UNTHROWN_EXCEPTION)) {
      return false;
    } else if (warning.hasDescription(at.dms.kopi.comp.kjc.KjcMessages.FIELD_RENAME_SUPER)
