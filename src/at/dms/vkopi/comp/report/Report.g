 ...
 *
 * $Id: Report.g,v 1.6 2002/12/06 10:10:02 laurent Exp $
 */

// Import the necessary classes
header { package at.dms.vkopi.comp.report; }
{
...
vrReportEvent []
  returns [int self]
:
  "PREREPORT"	{ self = at.dms.vkopi.lib.report.Constants.TRG_PREREPORT; }
|
  "POSTREPORT"	{ self = at.dms.vkopi.lib.report.Constants.TRG_POSTREPORT; }
;
...
vrField[VRParseReportContext report]
{
  ...
  String		group = null;
  VRFieldType		type;
  int			align = at.dms.vkopi.lib.report.Constants.ALG_DEFAULT;
  int			opts;
  int			multiField = 1;
  TokenReference	sourceRef = buildTokenReference();	// !!! add comment
...
:
  "ALIGN"
  (
    "LEFT"	{ self = at.dms.vkopi.lib.report.Constants.ALG_LEFT; }
  |
    "RIGHT"	{ self = at.dms.vkopi.lib.report.Constants.ALG_RIGHT; }
  |
    "CENTER"	{ self = at.dms.vkopi.lib.report.Constants.ALG_CENTER; }
  )
;
...
vrFieldOptions []
  returns [int self = 0]
:
  ( "HIDDEN" { self = at.dms.vkopi.lib.report.Constants.CLO_HIDDEN; } )*
;
...
vrFieldEvent []
  returns [int self]
:
  "FORMAT"	{ self = at.dms.vkopi.lib.report.Constants.TRG_FORMAT; }
|
  "COMPUTE"	{ self = at.dms.vkopi.lib.report.Constants.TRG_COMPUTE; }
;
