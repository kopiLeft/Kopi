 ...
 *
 * $Id: DBUtils.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
...
import at.dms.xkopi.lib.base.DBException;
...
public class DBUtils {
  ...
  private static void update_text(DBContext context, String[] params) throws SQLException {
    ...
    context.startWork();
    at.dms.xkopi.lib.base.Connection	conn = context.getDefaultConnection();
  ...
  private static void usage() {
    ...
    System.err.println(" driver: at.dms.tbx.TbxDriver");
