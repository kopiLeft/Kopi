 ...
 *
 * $Id: Main.java,v 1.2 2004/09/28 10:34:01 graf Exp $
 */

package at.dms.vkopi.lib.doc;
...
import at.dms.vkopi.lib.form.LatexPrintWriter;
...
public class Main {
  ...
  private static final void displayUsage() {
    ...
    System.err.println("Exemple: java at.dms.drivers.kopi.help.Main bugs \"DMS Bugs Report\" dms@jdbc:tbx://vie:4002/INTERN at.dms.tbx.TbxDriver XXXXXX");
  }
  ...
  public void doIt(String name, String title, boolean genImage) throws IOException {
    ...
    try {
      UIManager.setLookAndFeel(new at.dms.vkopi.lib.ui.plaf.KopiLookAndFeel());//UIManager.getSystemLookAndFeelClassName());
    } catch (Exception e) {
