...
%%
%% $Id: general.tex,v 1.2 2001/05/24 19:28:36 graf Exp $
%%
...
dargestellt werden (z.B. kennzeichnet \Taste{F1} die Funktionstaste F1).
Eine Tastenkombination (d.h. zwei Tasten m\"{u}ssen gleichzeitig
gedr\"{u}ckt werden) wird durch die zwei Tasten und ein ``+'' dargestellt (z.B. \Taste{shift}+\Taste{TAB} bedeutet, da{\ss} die
Taste \Taste{shift} gleichzeitig mit der Taste \Taste{TAB}
