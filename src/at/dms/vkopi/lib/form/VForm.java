 ...
 *
 * $Id: VForm.java,v 1.3 2004/11/12 13:31:26 lackner Exp $
 */
...
import at.dms.vkopi.lib.visual.Module;
import at.dms.vkopi.lib.visual.SActor;
import at.dms.vkopi.lib.visual.SDefaultActor;
...
import at.dms.vkopi.lib.visual.VHelpViewer;
import at.dms.vkopi.lib.visual.VInterruptException;
...
public abstract class VForm extends VWindow implements VConstants {
  ...
  /**
   * GOTO PAGE X
   * @exception	at.dms.vkopi.lib.visual.VException	an exception may be raised by field.leave
   */
   ...
   * @exception	at.dms.vkopi.lib.visual.VException	an exception may be raised by string formaters
   */
   ...
   * Handles transaction failure
   * @param	reason		the reason for the failure.
   * @exception	at.dms.vkopi.lib.visual.VException	an exception may be raised by DB
   *//* old version
