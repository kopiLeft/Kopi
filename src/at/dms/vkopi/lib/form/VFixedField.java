 ...
 *
 * $Id: VFixedField.java,v 1.1 2004/07/28 18:43:27 imad Exp $
 */
...
public class VFixedField extends VField {
  ...
  public String getTypeInformation() {
    ...
    at.dms.xkopi.lib.type.Fixed big = new NotNullFixed(nines - 1);
    big = big.setScale(height);
    at.dms.xkopi.lib.type.Fixed mbig = new NotNullFixed(-(nines / 10 - 1));
