 ...
 * * $Id: KopiLookAndFeel.java,v 1.3 2004/11/04 14:29:47 lackner Exp $
 */
...
public class KopiLookAndFeel extends MetalLookAndFeel {
  public KopiLookAndFeel() {
    ...
    if (!isInstalled) {
      UIManager.installLookAndFeel(new UIManager.LookAndFeelInfo("Kopi", "at.dms.vkopi.lib.ui.plaf.KopiLookAndFeel"));
      isInstalled = true;
    }
  }
  ...
  protected void putDefault(UIDefaults table, String uiKey) {
    try {
      String className = "at.dms.vkopi.lib.ui.plaf.Kopi"+uiKey;
