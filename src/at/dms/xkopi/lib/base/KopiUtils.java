...
public class KopiUtils {
   ...
   * execute an query and close statement
   */
  public static final int executeUpdate(at.dms.xkopi.lib.base.Connection conn, String text, Object[] blobs)
    throws DBException
  {
    try {
   ...
   * execute an query and close statement
   */
  public static final int executeUpdate(at.dms.xkopi.lib.base.Connection conn, String text) throws DBException {
    try {
   ...
   */
  private static final String createKopiInsertStatement(at.dms.xkopi.lib.base.Connection conn,
                                                        String table,
                                                        int id,
                                                        String[] columns,
                                                        String[] values)
   ...
   */
  public static final int executeKopiInsert(at.dms.xkopi.lib.base.Connection conn,
					    String table,
					    String[] columns,
					    String[] values,
                                            Object[] blobs)
   ...
   * execute an query and close statement
   */
  public static final int getNextTableId(at.dms.xkopi.lib.base.Connection conn,
                                         String table)
    throws DBException
  {
    try {
   ...
   *
   * !!! Note: This method should be moved to at.dms.xkopi.lib.base.Utils
   */
