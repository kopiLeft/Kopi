 ...
 *
 * $Id: Db2UdbDriverInterface.java,v 1.1 2004/07/28 18:43:27 imad Exp $
 */
 ...
 */
public class Db2UdbDriverInterface extends DriverInterface {

  /**
   * Constructs a new driver interface object
   */
  public Db2UdbDriverInterface() {
    super();
  }
  ...
  public String convertSql(String from) {
    try {
      Db2UdbParser	parser = new Db2UdbParser(from);
 ...
 */
/*package*/ class Db2UdbParser extends JdbcParser {
  /**
   * Constructor
   */
