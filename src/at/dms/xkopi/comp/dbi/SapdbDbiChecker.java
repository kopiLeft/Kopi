 ...
 *
 * $Id: SapdbDbiChecker.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
...
import at.dms.xkopi.lib.base.SapdbDriverInterface;
 ...
 *
 */
public class SapdbDbiChecker extends DbiChecker implements DbiVisitor {

  /**
   * Constructs a new SapdbDbiChecker object.
   */
  public SapdbDbiChecker(SqlContext sql) {
    super(sql);
  }
