 ...
 *
 * $Id: MonthType.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
...
public class MonthType extends Type implements DbiType {
   ...
   */
  public MonthType(TokenReference ref) {
    super(ref);
  }
 ...
 /**
  ...
  public DatabaseColumn getColumnInfo(boolean nullable) {
    return new DatabaseMonthColumn(nullable);
  }  
