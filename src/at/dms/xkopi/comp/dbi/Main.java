...
public class Main extends Compiler implements Constants {
  ...
  protected boolean initialize() {
    ...
    try {
      at.dms.xkopi.lib.base.DBContext.registerDriver(options.driver);
      if (options.url != null) {
	context = new at.dms.xkopi.lib.base.DBContext();
	context.setDefaultConnection(context.createConnection(options.url, options.login, options.passwd));
      }
      if (options.commit != null) {
	dictContext = new at.dms.xkopi.lib.base.DBContext();
