 ...
 *
 * $Id: XProtectedContext.java,v 1.1 2004/07/28 18:43:27 imad Exp $
 */
 ...
 *
 */
public class XProtectedContext extends CBodyContext {
   ...
   */
  public XProtectedContext(CBodyContext parent, KjcEnvironment environment, XProtectedStatement stmt) {
   ...
   */
  public XProtectedStatement getProtectedStatement() {
    return stmt;
  }
  ...
  private XProtectedStatement		stmt;
}
