 ...
 *
 * $Id: XTimeType.java,v 1.1 2004/07/28 18:43:27 imad Exp $
 */
 ...
 */
public class XTimeType extends XPrimitiveClassType {
   ...
   */
  public XTimeType() {
    super(at.dms.xkopi.lib.type.NotNullTime.class.getName().replace('.','/'));
  }
