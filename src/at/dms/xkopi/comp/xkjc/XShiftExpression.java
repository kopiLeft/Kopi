 ...
 *
 * $Id: XShiftExpression.java,v 1.1 2004/07/28 18:43:27 imad Exp $
 */

package at.dms.xkopi.comp.xkjc;

import at.dms.kopi.comp.kjc.JShiftExpression;
 ...
 */
public class XShiftExpression extends JShiftExpression {
   ...
   */
  public XShiftExpression(TokenReference where,
			  int oper,
			  JExpression left,
			  JExpression right) {
