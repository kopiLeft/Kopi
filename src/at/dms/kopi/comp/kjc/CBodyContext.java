 ...
 *
 * $Id: CBodyContext.java,v 1.2 2004/09/28 10:34:01 graf Exp $
 */
...
public abstract class CBodyContext extends CContext {
  ...
  public void mergeThrowables(CBodyContext source) {
    for (Enumeration elems = source.getThrowables().elements(); elems.hasMoreElements(); ) {
      addThrowable((CThrowableInfo)elems.nextElement());
    }
  }
