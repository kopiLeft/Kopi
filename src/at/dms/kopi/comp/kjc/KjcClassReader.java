 ...
 *
 * $Id: KjcClassReader.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
 ...
 */
public class KjcClassReader extends at.dms.util.base.Utils implements ClassReader{
    ...
    if (cl != null) {
      ...
      if (cl instanceof CBinaryClass) {
        try {
          ...
          e.addPosition(at.dms.compiler.base.TokenReference.NO_REF);
          e.printStackTrace();
