 ...
 *
 * $Id: KopiConstraintStatement.java,v 1.1 2004/07/28 18:43:28 imad Exp $
 */
...
//     if (%(boolean)[0]) {
//       if (!(at.dms.kopi.lib.assertion.AssertionRuntime.getRunAssertion(Thread.currentThread()))) {
//         at.dms.kopi.lib.assertion.AssertionRuntime.setRunAssertion(Thread.currentThread(), true);
//         try {
//           %[0]     // invariant
//           %[2]     // precondition
//           %[3]     // postcondition  storage
//         } finally {
//           at.dms.kopi.lib.assertion.AssertionRuntime.setRunAssertion(Thread.currentThread(), false);
//         }
//       }
//     }
//     try {
