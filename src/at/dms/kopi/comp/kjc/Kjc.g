...
header { package at.dms.kopi.comp.kjc; }
{
      ...
      if (environment.getAssertExtension() == KjcEnvironment.AS_ALL) {
        ...
        self = new KopiConstructorDeclaration(sourceRef,
                                              ...
                                              new KopiConstructorBlock(sourceRef,
                                                                       constructorCall,
                                                                       (JStatement[]) body.toArray(new JStatement[body.size()])), //at.dms.util.base.Utils.toArray(body, JStatement.class)),
                                              javadoc,
                                              getStatementComment(),
                                              pre,
                                              post,
...
:
  ...
  { self = (JExpression[])vect.toArray(new JExpression[vect.size()]); } //at.dms.util.base.Utils.toArray(vect, JExpression.class); }
;
...
:
  ...
  { self = (JExpression[]) container.toArray(new JExpression[container.size()]); } //at.dms.util.base.Utils.toArray(container, JExpression.class); }
;
