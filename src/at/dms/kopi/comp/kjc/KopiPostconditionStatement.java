 ...
 *
 * $Id: KopiPostconditionStatement.java,v 1.2 2004/10/04 13:37:40 lackner Exp $
 */
...
public class KopiPostconditionStatement extends JStatement {
  ...
  public void analyseConditions()  throws PositionedError {
    ...
    if (fields.length == 0) {
      ...
      try {
        ((CSourceMethod) method).setOldValueStore((CReferenceType)new CClassOrInterfaceType(getTokenReference(), storeClass.getCClass()).checkType(conditionContext));
