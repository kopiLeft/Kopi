...
package com.kopiright.bytecode.memcnt;
 ...
 */
public class Instrumenter implements com.kopiright.bytecode.classfile.Constants {
  ...
  private void instrumentInitializer() {
    ...
    insns = new Instruction[] {
      ...
      new MethodRefInstruction(opc_invokestatic, "com/kopiright/bytecode/memcnt/Registry/register", "(Ljava/lang/String;)V")
    };
