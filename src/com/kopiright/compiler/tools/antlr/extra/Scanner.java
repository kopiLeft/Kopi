...
import com.kopiright.compiler.tools.antlr.runtime.TokenStream;
...
public abstract class Scanner implements TokenStream {
  ...
  public JavaStyleComment[] getStatementComment() {
    if (comments.size() == 0) {
      return JavaStyleComment.EMPTY;
    } else {
      JavaStyleComment[]	comm ;

      comm = (JavaStyleComment[])Utils.toArray(comments, JavaStyleComment.class);
