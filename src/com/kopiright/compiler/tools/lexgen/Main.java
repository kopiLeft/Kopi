...
package com.kopiright.compiler.tools.lexgen;
...
import com.kopiright.compiler.tools.jperf.JPerf;
...
public class Main {
  ...
  private boolean buildKeywordFile() {
    ...
    header.addElement("import com.kopiright.compiler.tools.antlr.extra.CToken;\n");
