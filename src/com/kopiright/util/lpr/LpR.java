...
public class LpR {
   ...
   * @exception	com.kopiright.util.lpr.LpdException	if some problems occurs during
   *				connection to lpd
   */
  ...
  /**
   * Program entry point
   * @exception	com.kopiright.util.lpr.LpdException	problem during communication with lpd
