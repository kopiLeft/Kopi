 ...
 *
 * $Id: XDate.x,v 1.2 2001/05/24 19:28:56 graf Exp $
 */
 ...
 *
 * The class used to represents date is com.kopiright.xkopi.lib.type.Date
...
public class XDate {
  ...
  public static NotNullDate operator:()(Date i) {
    ...
    return com.kopiright.xkopi.lib.type.NotNullDate.castToNotNull(i);
  }
