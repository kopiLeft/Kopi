...
public class XExecSqlStatement extends XStatement {
  ...
  /**
   * 
   * com.kopiright.xkopi.lib.base.KopiUtils.executeUpdate((Connection)exprs[0], (String)expr[1]);
   */
  ...
  new JBlock(ref, new JStatement[] {
    new JVariableDeclarationStatement(ref,
                                      new JVariableDefinition(ref, 0, CReferenceType.lookup(com.kopiright.xkopi.lib.base.Query.class.getName().replace('.','/')), "qry$", new JNullLiteral(ref)), 
                                      null), 
      new JExpressionStatement(ref, 
                               new JAssignmentExpression(ref, 
                                                         new JNameExpression(ref, "qry$"), 
                                                         new JUnqualifiedInstanceCreation(ref, 
                                                                                          CReferenceType.lookup(com.kopiright.xkopi.lib.base.Query.class.getName().replace('.','/')), 
      ...
      new JIfStatement(ref, 
                       ...
                       new JThrowStatement(ref,
                                           new JUnqualifiedInstanceCreation(ref, 
                                                                            CReferenceType.lookup(com.kopiright.xkopi.lib.base.DBNoRowException.class.getName().replace('.','/')), 
                                                                            JExpression.EMPTY),
                                           null)}, null), 
                       null, 
                       null), 
      ...
      new JIfStatement(ref, 
                       ...
                       new JThrowStatement(ref,
                                           new JUnqualifiedInstanceCreation(ref, 
                                                                            CReferenceType.lookup(com.kopiright.xkopi.lib.base.DBTooManyRowsException.class.getName().replace('.','/')), 
                                                                            JExpression.EMPTY), 
                                           null)}, null), 
                       null, 
                       null), 
