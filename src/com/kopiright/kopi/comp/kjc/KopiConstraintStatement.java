...
//     if (%(boolean)[0]) {
//       if (!(com.kopiright.kopi.lib.assertion.AssertionRuntime.getRunAssertion(Thread.currentThread()))) {
//         com.kopiright.kopi.lib.assertion.AssertionRuntime.setRunAssertion(Thread.currentThread(), true);
//         try {
//           %[0]     // invariant
//           %[2]     // precondition
//           %[3]     // postcondition  storage
//         } finally {
//           com.kopiright.kopi.lib.assertion.AssertionRuntime.setRunAssertion(Thread.currentThread(), false);
//         }
//       }
//     }
//     try {
