...
import com.kopiright.bytecode.classfile.ClassPath;
 ...
 */
public class KjcClassReader extends com.kopiright.util.base.Utils implements ClassReader{
    ...
    if (cl != null) {
      ...
      if (cl instanceof CBinaryClass) {
        try {
          ...
          e.addPosition(com.kopiright.compiler.base.TokenReference.NO_REF);
          e.printStackTrace();
