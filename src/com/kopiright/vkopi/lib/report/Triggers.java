...
public class Triggers {
  ...
  public static VCalculateColumn sumFixed(VReportColumn c) {
	...
	public Object evalNode(VReportRow row, int column) {
	  int			childCount = row.getChildCount();
	  com.kopiright.xkopi.lib.type.NotNullFixed	result = new com.kopiright.xkopi.lib.type.NotNullFixed(0, 2);

	  for (int i = 0; i < childCount; i++) {
	    VReportRow	child = (VReportRow)row.getChildAt(i);
	    com.kopiright.xkopi.lib.type.NotNullFixed value = (com.kopiright.xkopi.lib.type.NotNullFixed)child.getValueAt(column);
	    if  (value != null) {
  ...
  public static VCalculateColumn avgFixed(VReportColumn c) {
	...
	public Object evalNode(VReportRow row, int column) {
	  ...
	  return result.divide(new com.kopiright.xkopi.lib.type.NotNullFixed(childCount));
	}
      };
  }
}
