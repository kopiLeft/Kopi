...
public class VFixedCodeColumn extends VCodeColumn {
   ...
   */
  public VFixedCodeColumn(String ident,
                          String type,
                          String source,
                          int options,
                          int align,
                          ...
                          VCellFormat format,
                          String[] names,
                          com.kopiright.xkopi.lib.type.NotNullFixed[] codes)
  {
  ...
  private final com.kopiright.xkopi.lib.type.NotNullFixed[]		codes;	// array of internal representations
}
