...
import com.kopiright.vkopi.lib.visual.ModelCloseListener;
...
public abstract class JApplication implements Application {
  ...
  protected ImageIcon getSplashScreenImage() {
    return com.kopiright.vkopi.lib.ui.swing.base.Utils.getImage("splash.jpg");
  }
  ...
  public boolean run(String[] args) {
    try {
      UIManager.setLookAndFeel(new com.kopiright.vkopi.lib.ui.swing.plaf.KopiLookAndFeel());//UIManager.getSystemLookAndFeelClassName());
    } catch (Exception e) {
