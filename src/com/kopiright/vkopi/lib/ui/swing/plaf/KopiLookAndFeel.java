...
package com.kopiright.vkopi.lib.ui.swing.plaf;
...
public KopiLookAndFeel() {
    ...
    if (!isInstalled) {
      UIManager.installLookAndFeel(new UIManager.LookAndFeelInfo("Kopi", "com.kopiright.vkopi.lib.ui.swing.plaf.KopiLookAndFeel"));
      isInstalled = true;
    }
  }
  ...
  protected void putDefault(UIDefaults table, String uiKey) {
    try {
      String className = "com.kopiright.vkopi.lib.ui.swing.plaf.Kopi"+uiKey;
