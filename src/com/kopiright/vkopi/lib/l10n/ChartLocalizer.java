...
public class ChartLocalizer extends Localizer {
   ...
   */
  public ChartLocalizer(LocalizationManager manager, Document document) {
    super(manager);
    this.root = document.getRootElement();
    if (! root.getName().equals("chart")) {
  ...
  public FieldLocalizer getFieldLocalizer(String ident) {
    return new FieldLocalizer(getManager(), Utils.lookupChild(root, "field", "ident", ident));
  }
