 ...
 */
public class Main extends com.kopiright.xkopi.comp.xkjc.Main {
  ...
  protected boolean filterWarning(CWarning warning) {
    if (warning.hasDescription(com.kopiright.kopi.comp.kjc.KjcMessages.METHOD_UNTHROWN_EXCEPTION)) {
      return false;
    } else if (warning.hasDescription(com.kopiright.kopi.comp.kjc.KjcMessages.FIELD_RENAME_SUPER)
