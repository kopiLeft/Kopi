...
:
{
  ...
  context.addPackageImport(new JPackageImport(TokenReference.NO_REF, "com/kopiright/xkopi/lib/base", null));
  context.addPackageImport(new JPackageImport(TokenReference.NO_REF, "com/kopiright/xkopi/lib/type", null));
...
:
  ...
  |
    SEMI
      { reportTrouble(new CWarning(sourceRef, com.kopiright.kopi.comp.kjc.KjcMessages.STRAY_SEMICOLON, null)); }
  )*
  RCURLY
;
