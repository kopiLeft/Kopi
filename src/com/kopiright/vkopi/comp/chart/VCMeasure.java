...
public class VCMeasure extends VCField {
  ...
  private JExpression getColor() {
    ...
    for (int i = 0; i < triggers.length; i++) {
      if ((triggers[i].getEvents() & (1 << com.kopiright.vkopi.lib.chart.CConstants.TRG_COLOR)) > 0) {
	JExpression	expr;
	...
	expr = new JMethodCallExpression(ref,
					 ...
					 "callTrigger",
					 new JExpression[]{
					   VKUtils.toExpression(ref, com.kopiright.vkopi.lib.chart.CConstants.TRG_COLOR),
