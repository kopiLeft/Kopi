...
import com.kopiright.vkopi.comp.trig.GKjcPrettyPrinter;
...
/*
	...
	if (pack.equals("com.kopiright.vkopi.lib.visual")) {
	  continue;
	}
	if (pack.equals("com.kopiright.vkopi.lib.util")) {
	  continue;
	}
	if (pack.equals("com.kopiright.xkopi.lib.base")) {
	  continue;
	}
	if (pack.equals("java.sql")) {
	  continue;
	}
	if (pack.equals("com.kopiright.vkopi.lib.form")) {
	  continue;
	}
	newLine();
	print("import\t" + pack + ".*;");
  ...
  protected void printCopyright(String name) {
    print("///////////////////////////////////////////////////////////////////////////////");
    newLine();
    print("/// Copyright (c) 1990-2006 kopiRight Managed Solutions GmbH                ///");
    newLine();
