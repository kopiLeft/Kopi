...
public class VKUtils {
  ...
  public static final CReferenceType[]	VECT_VException = new CReferenceType[] {CReferenceType.lookup(com.kopiright.vkopi.lib.visual.VException.class.getName().replace('.','/'))};
