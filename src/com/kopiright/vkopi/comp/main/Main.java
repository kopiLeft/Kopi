...
package com.kopiright.vkopi.comp.main;
...
import com.kopiright.compiler.base.WarningFilter;
import com.kopiright.compiler.tools.antlr.extra.InputBuffer;
import com.kopiright.compiler.tools.antlr.extra.Parser;
...
public class Main extends Compiler implements VKInsertParser {
  ...
  public boolean run(String[] args) {
    ...
    if (options.sqlCase != null) {
      if (options.sqlCase.equals("upper")) {
        com.kopiright.xkopi.comp.xkjc.XUtils.sqlToUpper = true;
      } else {
        options.usage();
  ...
  protected boolean filterWarning(CWarning warning) {
    ...
    default:
      throw new com.kopiright.util.base.InconsistencyException();
    }
  }
  ...
  protected WarningFilter getFilter() {
    if (filter == null) {
      ...
      if (filter == null) {
        filter = new com.kopiright.kopi.comp.kjc.DefaultFilter();
      }
    }
