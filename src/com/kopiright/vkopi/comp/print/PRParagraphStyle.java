...
public class PRParagraphStyle extends PRStyle {
  ...
  private static CReferenceType	TYPE = CReferenceType.lookup(com.kopiright.vkopi.lib.print.PParagraphStyle.class.getName().replace('.','/'));
  private static CReferenceType	TAB_STOP = CReferenceType.lookup(com.kopiright.vkopi.lib.print.PTabStop.class.getName().replace('.','/'));
