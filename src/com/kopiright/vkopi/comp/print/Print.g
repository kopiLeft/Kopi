...
header { package com.kopiright.vkopi.comp.print; }
{
...
:
  ...
  {
    self = (PRTabStop[])com.kopiright.util.base.Utils.toArray(vect, PRTabStop.class);
  }
;
...
:
  ...
  "END" "BLOCK"
  {
    self = new PRRecursiveBlock(sourceRef,
				...
				pos,
				blockStyle,
				(PRBlock[])com.kopiright.util.base.Utils.toArray(blocks, PRBlock.class));
  }
;
  ...
  "END" "BLOCK"
    {
      self = new PRListBlock(sourceRef,
			     ...
			     pos,
			     blockStyle,
			     (PRStyle[])com.kopiright.util.base.Utils.toArray(styles, PRStyle.class),
			     trigs);
   }
;
...
:
  ( trig = prTrigger[] { trigs.addElement(trig); } )+
    {
      self = (PRTrigger[])com.kopiright.util.base.Utils.toArray(trigs, PRTrigger.class);
    }
;
...
:
  ...
  {
    self = (PRSourceElement[])com.kopiright.util.base.Utils.toArray(vect, PRSourceElement.class);
  }
;
