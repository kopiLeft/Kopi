...
public class PRPage
  extends VKPhylum
  implements VKCompilationUnit, com.kopiright.kopi.comp.kjc.Constants
{
  ...
  public static CReferenceType	TYPE		= CReferenceType.lookup(com.kopiright.vkopi.lib.print.PPage.class.getName().replace('.','/'));
  public static CReferenceType	TYPE_PROTECTED	= CReferenceType.lookup(com.kopiright.vkopi.lib.print.PProtectedPage.class.getName().replace('.','/'));
  public static CReferenceType	BLOCK_TYPE	= CReferenceType.lookup(com.kopiright.vkopi.lib.print.PBlock.class.getName().replace('.','/'));
  public static CReferenceType	STYLE_TYPE	= CReferenceType.lookup(com.kopiright.vkopi.lib.print.PBlock.class.getName().replace('.','/')); // !!! TO REMOVE
