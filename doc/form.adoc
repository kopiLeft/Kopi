...
A message can be used to display user notifications, warnings, errors and even form title. It can contain parameters that are substituted by their values at the message format call. To format a message, the formatMessage(String, Object[]) can be called.
...
[source,java]
----
MESSAGE Title "This is the form title"
----
...
[source,java]
----
setTitle(formatMessage("Title", new Object[] {o1, o2}));
----
...
MESSAGE Title "This is the form title with {0 ?, choice,0#param 0 is null
|1#param 0 is not null {0}} and {1,choice,0#param 1 is false|1#param 1 is true}"

setTitle(formatMessage("Title", new Object[] {null, new Boolean(true)}));
----
...
MESSAGE Title "This is the form title with {0 ?, choice,0#{2 ?,choice,
#0param 3 is null|1#param 3 is not null}|1#param 0 is not null {0}}
and {1,choice,0#param 1 is false|1#param 1 is true}"

setTitle(formatMessage("Title", new Object[] {"test", new Boolean(true), null}));
----
